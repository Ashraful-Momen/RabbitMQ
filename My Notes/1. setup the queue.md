...
producer (send msg ) ---- > Exchange(Type : Direct/Topic-wildCard/Fangout-broadCasting) receive msg --------> send msg ---------------> Consumer receiver Msg () 


#Exchange : bind a option that , Binding Exchange with Queue.  
